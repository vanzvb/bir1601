                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header bg-primary text-white">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1 class="text-center fs-3">BIR 1601 NEW REPORT</h1>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered w-100" id="manageBIR">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-white bg-primary text-center fw-bold">Total DMM</th>
                                                        <th class="text-white bg-primary text-center fw-bold">Total E</th>
                                                        <th class="text-white bg-primary text-center fw-bold">Total Deduction</th>
                                                        <th class="text-white bg-primary text-center fw-bold">Total Gross Pay</th>
                                                        <th class="text-white bg-primary text-center fw-bold">Total Tax</th>
                                                    </tr>
                                                </thead>
